...
@endif
    ...
    <div class="card-header">
        <h5 class="mb-0">Ajouter un Impot</h5>
    </div>
    <div class="card-body">
        <form method="post" action="{{ route('impots.store') }}">
            ...
            <div class="mb-3">
                <label for="name" class="form-label">Code d'accé</label>
                <input type="number" class="form-control" id=" code_acce" name=" code_acce" required>
            </div>
