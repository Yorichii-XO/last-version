...
<div class="container">
    <a href="{{route('gerants.index')}}"><button type="submit" class="btn btn-primary" style=" background-color:#00FFFF;color:#000000">Retour</button></a>
        <div class="details-section">
            <h4>Information de gérant:</h4>
            <ul class="details-list row">
                <div class="col-md-4"><li><strong>Nom complet:</strong> {{$gerant->name}}</li></div>
                <div class="col-md-4"><li><strong>Email:</strong> {{$gerant->email}}</li></div>
                <div class="col-md-4"><li><strong>N°cin:</strong> {{$gerant->cin}}</li></div>
        ...
        <div class="details-section">
            <h4> Information de société:</h4>
            <ul class="details-list row">
                <li class="col-md-4"><strong>Societe Name:</strong> {{$gerant->societe->name}}</li>
                <li class="col-md-4"><strong>Forme Juridique:</strong> {{$gerant->societe->formes_juridique}}</li>
                <li class="col-md-4"><strong>Siege Social:</strong> {{$gerant->societe->siege_social}}</li>
                <li class="col-md-4"><strong>Capital:</strong> {{$gerant->societe->capital}}</li>
                <li class="col-md-4"><strong>Activite Principal:</strong> {{$gerant->societe->activite_principal}}</li>
                ...
                <li class="col-md-4"><strong>Date Exploitation:</strong> {{$gerant->societe->date_exploitation}}</li>
                <li class="col-md-4"><strong>Date DbDexploitation:</strong> {{$gerant->societe->date_debut_exploitation}}</li>
            </ul>
        </div>
    </div>
