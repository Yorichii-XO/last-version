...
@media (max-width: 767px) {
    ...
    <div class="container">
    <a href="{{route('associes.index')}}"><button type="submit" class="btn btn-primary" style=" background-color:#00FFFF;color:#000000">Retour</button></a>
        <div class="details-section">
            <h4>Information d'Associé:</h4>
            <ul class="details-list row">
                <div class="col-md-4"><li><strong>Nom complet:</strong> {{$associe->name}}</li></div>
                <div class="col-md-4"><li><strong>Email:</strong> {{$associe->email}}</li></div>
                <div class="col-md-4"><li><strong>N°cin:</strong> {{$associe->cin}}</li></div>
        ...
        <div class="details-section">
            ...
            <ul class="details-list row">
                ...
                <li class="col-md-4"><strong>Forme Juridique:</strong> {{$associe->societe->formes_juridique}}</li>
                <li class="col-md-4"><strong>Siege Social:</strong> {{$associe->societe->siege_social}}</li>
                <li class="col-md-4"><strong>Capital:</strong> {{$associe->societe->capital}}</li>
                <li class="col-md-4"><strong>Activite Principal:</strong> {{$associe->societe->activite_principal}}</li>
                ...
                <li class="col-md-4"><strong>Date Exploitation:</strong> {{$associe->societe->date_exploitation}}</li>
                <li class="col-md-4"><strong>Date DbDexploitation:</strong> {{$associe->societe->date_debut_exploitation}}</li>
            </ul>
        </div>
    </div>
