...
@endif
    ...
    <div class="card-header">
        <h5 class="mb-0">Modifier Associé</h5>
    </div>
    <div class="card-body">
        <form method="post" action="{{ route('associes.update', $associé->id) }}">
            ...
            <div class="mb-3">
                <label for="name" class="form-label">                                        Nom complet
                </label>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="societe_id" name="societe_id" required>
                        ...
                        @foreach($societes as $societe)
                                ...
                                <option value="{{ $societe->id }}" {{ $associé->societe_id == $societe->id ? 'selected' : '' }}>
                                    {{ $societe->name }}
                                </option>
                        @endforeach
                    </select>
