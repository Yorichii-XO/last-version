...
<head>
    ...
    <title>Modifiér une Damancom</title>
</head>
<style>
    .text-center-100 {
...
@endif
    ...
    <div class="card-header">
        <h5 class="mb-0">Modifiér une Damancom</h5>
    </div>
    <div class="card-body">
        <form method="post" action="{{ route('damancoms.update', $damancom->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="login" value="{{ $damancom->login }}" required>
            </div>
            <div class="mb-3">
